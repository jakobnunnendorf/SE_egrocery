...
export type PolymorphicMaterialSymbolProps<C extends React.ElementType> = PolymorphicComponentProps<C, MaterialSymbolProps>;
declare const MaterialSymbol: <C extends ElementType<any>>({ icon, onClick, as, weight, fill, grade, size, style: propStyle, color, ...props }: PolymorphicMaterialSymbolProps<C>) => ReactElement;
